...
const validationSchema = Yup.object().shape({
  waterAllocationNumber: Yup.string().label("Water Allocation Number").required(),
  password: Yup.string().label("Password").required().min(8, "Please enter a password that has more than 8 characters"),
        ...
        <Form>
          ...
          <div className="flex justify-end mt-6 pt-4">
            <button
              ...
              className="btn bg-transparent hover:bg-gray-700 text-gray-500 hover:text-gray-100 hover:border-transparent rounded-sm mr-2"
            >
              Cancel
            </button>
