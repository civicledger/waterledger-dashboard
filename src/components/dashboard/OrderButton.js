...
export default props => {
  ...
  const buttonClass = `flex-1 mr-2 border border-${colour}-200 text-${colour}-500 rounded-sm mt-5 p-3 cursor-pointer hover:border-${colour}-400 hover:bg-${colour}-200 ${props.responsive}`;
