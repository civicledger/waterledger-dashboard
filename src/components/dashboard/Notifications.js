...
const notificationItem = ({ id, type = "info", text }) => {
  const classes = classNames("inline-flex mx-5 mt-3 lg:mx-0 p-3 shadow bg-steel-700 rounded border", {
...
const Notifications = ({ notifications }) => {
  ...
  return (
    <ul className="inline-flex fixed flex-col right-0 sm:ml-5 lg:mr-5 mt-20 lg:mt-5 items-end notifications">
