...
const TopNav = ({ ethContext }) => {
  ...
  return (
    <div className="flex lg:hidden border border-gray-300 border-b-1 border-t-0 border-r-0 border-l-0 bg-white">
      <div className="flex-shrink py-1">
        <img src={waterLedgerLogo} alt="Water Ledger logo" className="logo-image" />
      </div>
      <div className="flex-1 mt-4 text-2xl civic">
